...
SERVICES = [
  dict(slug="business-card-printing", name="Business Card Printing", title="Business Card Printing in Lisbon",
    desc="Premium business cards with matte, gloss, soft-touch, or textured finishes — the first impression your business deserves.",
    img="https://images.unsplash.com/photo-1561015314-6bd8c1e875ee?w=900&q=80",
    benefits=["Premium 350–600gsm card stock options","Matte, gloss, soft-touch & spot-UV finishes","Rounded corners and custom shapes available","Low minimum order quantities","Fast 24–48h turnaround"],
    ...
    turnaround="24–48 hours for standard orders.",
    faqs=[("What's the minimum order quantity?","We can print as few as 100 business cards, with better per-unit pricing at higher quantities."),
          ...
          ("Do you offer design services?","Yes — our designers can build your business card from scratch or refine your existing files.")]),
  dict(slug="flyer-printing", name="Flyer Printing", title="Flyer & Folded Flyer Printing in Lisbon",
    desc="Bold, attention-grabbing flyers for promotions, events, and local marketing — printed fast on quality paper stock.",
    img="https://images.unsplash.com/photo-1695634621375-0b66a9d5d1bc?w=900&q=80",
    benefits=["Vivid full-color printing","Single and folded flyer formats","Bulk pricing for large campaigns","Quick reprints for recurring promotions","Free layout check before printing"],
    ...
    turnaround="24–48 hours for standard runs.",
  ...
  dict(slug="folded-flyer-printing", name="Folded Flyer Printing", title="Folded Flyer Printing (Bi-Fold & Tri-Fold) in Lisbon",
    ...
    benefits=["More space to tell your story than a flat flyer","Bi-fold and tri-fold formats","Crisp, accurate folding on every unit","Durable stock options for handouts","Fast turnaround for time-sensitive campaigns"],
    ...
    turnaround="48–72 hours for folded formats.",
  ...
  dict(slug="poster-printing", name="Poster Printing", title="Poster Printing in Lisbon",
    desc="Large-format posters for promotions, events, and in-store displays — sharp print quality at any size.",
    img="https://images.unsplash.com/photo-1563050860-87d45eaaeabb?w=900&q=80",
    benefits=["Vibrant large-format color printing","Indoor and outdoor-rated stock options","Custom sizes for any wall or window","Bulk pricing for multi-location campaigns","Same-week turnaround"],
    ...
    turnaround="24–72 hours depending on size and quantity.",
  ...
  dict(slug="restaurant-menu-printing", name="Restaurant Menu Printing", title="Restaurant Menu Printing in Lisbon",
    ...
    turnaround="48–72 hours for standard menus.",
  ...
  dict(slug="banner-printing", name="PVC Banner Printing", title="PVC Banner Printing in Lisbon",
    desc="Big, bold, weatherproof banners for storefronts, events, and promotions — built to last outdoors.",
    ...
    turnaround="48–72 hours for standard sizes.",
  ...
  dict(slug="roll-up-banner-printing", name="Roll-up Banner Printing", title="Roll-up Banner Printing in Lisbon",
    ...
    turnaround="48–72 hours including stand assembly.",
  ...
  dict(slug="window-graphics-printing", name="Window Graphics Printing", title="Window Graphics & Vinyl Printing in Lisbon",
    ...
    sizes=["Custom — measured to your window"],
    ...
    turnaround="48–72 hours including installation scheduling.",
  ...
  dict(slug="packaging-printing", name="Packaging Printing", title="Custom Packaging Printing in Lisbon",
    ...
    sizes=["Custom — based on your product"],
    ...
    turnaround="5–10 business days depending on complexity.",
    faqs=[("Can packaging be food-safe?","Yes, we offer food-safe coatings and materials suitable for restaurants and cafés."),
          ("What's the minimum order for custom packaging?","Minimums vary by structure — message us with your product details for an exact quote.")]),
  dict(slug="booklet-printing", name="Booklet & Catalogue Printing", title="Booklet, Brochure & Catalogue Printing in Lisbon",
    ...
    turnaround="3–5 business days depending on page count.",
...
hub_body = page_hero(1,"Our Services","Printing Services for Every Business Need","From everyday essentials to large-format signage — explore our full range of printing services.", [("Home","index.html"),("Services",None)]) + f"""
...
{{"@context":"https://schema.org","@type":"Service","name":"{s['name']}","description":"{s['desc']}","provider":{{"@type":"LocalBusiness","name":"{BIZ}"}},"areaServed":"Portugal"}}
  ...
  write(f"services/{s['slug']}.html", page(
    f"{s['title']} | {BIZ}",
    f"{s['desc']} Fast turnaround, premium materials, and pricing on WhatsApp.",
